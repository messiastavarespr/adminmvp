...
import { X, CalendarClock, TrendingUp, TrendingDown, Layers, Repeat, FileText, AlertTriangle, Clock, Landmark } from './ui/Icons';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200">
        ...
        {/* Header */}
        <div className={`p-6 flex justify-between items-start text-white ${schedule.type === TransactionType.INCOME ? 'bg-emerald-600' : 'bg-rose-600'
          }`}>
          <div>
